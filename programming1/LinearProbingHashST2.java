...
//javac -classpath .:../lib/algs4.jar -d ../classes/cs310/ cs310/LinearProbingHashST2.java
//javac -classpath .:../lib/algs4.jar -d ../classes/ cs310/LinearProbingHashST2.java



// java -cp ..:../../lib/algs4.jar cs310.LinearProbingHashST2 < ../../src/tinyST.txt 
...
public class LinearProbingHashST2<Key, Value> {
    ...
    private int nt;          // true size for n
    private int m;           // size of linear probing table
    private Key[] keys;      // the keys
    private Value[] vals;    // the values
    private boolean[] flags;  // the active flags
    ...
    public Value get(Key key) {
        ...
        for (int i = hash(key); keys[i] != null && flags[i]; i = (i + 1) % m)
            if (keys[i].equals(key))
                return vals[i];
        return null;
    }
